...
#INFO sort_on (correct) - gives Python the function to use
#INFO sort_on() (incorrect) - tries to run the function right away with no arguments
#INFO sort_on(VAR) (incorrect) - tries to run the function right away with VAR
